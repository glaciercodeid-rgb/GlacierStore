...
// Cek status promo berdasarkan tanggal promoEnd.
// "expired" = ada promoEnd dan sudah lewat waktu sekarang.
// "active"  = promo aktif (manual tanpa jadwal, scheduled dalam rentang, atau belum punya end date).
